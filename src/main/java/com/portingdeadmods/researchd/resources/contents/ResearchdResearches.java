...
public class ResearchdResearches implements ResearchdResearchProvider {
    ...
    @Override
    public void build() {
        ResourceKey<Research> cobblestone = simpleResearch("cobblestone", builder -> builder.icon(Items.COBBLESTONE)
                .method(consumeItem(Items.COBBLESTONE, 4))
                .effect(and(unlockRecipe(mcLoc("stone_pickaxe")), unlockRecipe(mcLoc("furnace")))));
        ResourceKey<Research> stone = simpleResearch("stone", builder -> builder.icon(Items.STONE)
        ...
        ResourceKey<Research> different_rocks = simpleResearch("different_rocks", builder -> builder.icon(Items.DIORITE)
                .method(and(
                        or(hasItem(Items.DIORITE, 16), hasItem(Items.ANDESITE, 16), hasItem(Items.GRANITE, 16)),
        ...
        ResourceKey<Research> overworldPack =
                simpleResearch("overworld_pack", builder -> builder.icon(ResearchdItems.RESEARCH_LAB.asItem())
                        .parents(cobblestone)
                        .method(consumeItem(Items.IRON_INGOT, 4))
                        .effect(and(unlockRecipe(modLoc("research_lab")), unlockRecipe(modLoc("overworld_pack")))));
        ResourceKey<Research> nether = simpleResearch("nether", builder -> builder.icon(Items.NETHERRACK)
                .parents(overworldPack)
                .method(consumePack(25, 100, pack(ResearchdResearchPacks.OVERWORLD_PACK_LOC)))
                .effect(and(
                        unlockRecipe(modLoc("nether_pack")),
                        unlockDimension(mcLoc("the_nether"), DimensionUnlockEffect.NETHER_SPRITE))));
        ResourceKey<Research> cake = simpleResearch("cake", builder -> builder.icon(Items.CAKE)
                .parents(nether)
                .method(hasItem(Items.CAKE, 1))
                .effect(unlockItem(Items.CAKE)));
        ResourceKey<Research> end = simpleResearch("the_end", builder -> builder.icon(Items.END_STONE)
                .parents(nether)
                .method(consumePack(
                        100,
                        200,
                        pack(ResearchdResearchPacks.OVERWORLD_PACK_LOC),
                        pack(ResearchdResearchPacks.NETHER_PACK_LOC)))
                .effect(and(
                        unlockRecipe(modLoc("end_pack")),
                        unlockDimension(mcLoc("the_end"), DimensionUnlockEffect.END_SPRITE))));
        simpleResearch("end_crystal", builder -> builder.icon(Items.END_CRYSTAL)
                ...
                .method(consumePack(
                        ...
                        pack(ResearchdResearchPacks.OVERWORLD_PACK_LOC),
                        pack(ResearchdResearchPacks.NETHER_PACK_LOC),
                        pack(ResearchdResearchPacks.END_PACK_LOC)))
                .effect(and(unlockRecipe(mcLoc("end_crystal")))));
        simpleResearch("beacon", builder -> builder.icon(Items.BEACON)
                .parents(end)
                .method(consumePack(
                        250,
                        200,
                        ...
                        pack(ResearchdResearchPacks.NETHER_PACK_LOC),
                        pack(ResearchdResearchPacks.END_PACK_LOC)))
                .effect(and(unlockRecipe(mcLoc("beacon")))));
    }

    public void buildExampleDatapack() {
        ResourceKey<Research> wood = simpleResearch("wood", builder -> builder.literalName("Wood")
        ...
        ResourceKey<Research> iron = simpleResearch("iron", builder -> builder.literalName("Iron")
        ...
        simpleResearch("nether_dim", builder -> builder.literalName("Nether")
