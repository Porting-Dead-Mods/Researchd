...
public final class ResearchEffectSerializers {
	...
	static {
		SERIALIZERS.register("unlock_dimension", () -> DimensionUnlockEffect.Serializer.INSTANCE);
		SERIALIZERS.register("unlock_recipe", () -> RecipeUnlockEffect.Serializer.INSTANCE);
	}
}
