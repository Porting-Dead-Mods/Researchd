...
public interface ResearchEffectDataType<T extends ResearchEffectData<?>> {
    ...
    static <T extends ResearchEffectData<?>> ResearchEffectDataType<T> simple(
            Supplier<T> factory, MapCodec<T> codec, StreamCodec<? super RegistryFriendlyByteBuf, T> streamCodec) {
    ...
    record Simple<T extends ResearchEffectData<?>>(
            Supplier<T> factory, MapCodec<T> codec, StreamCodec<? super RegistryFriendlyByteBuf, T> streamCodec)
            implements ResearchEffectDataType<T> {
        @Override
        public T create() {
