...
public final class ResearchdRenderTypes {
    public static final RenderType LINES_NONTRANSLUCENT = createDefault(
            Researchd.MODID + ":nontranslucent_lines",
    ...
    private static RenderType createDefault(
            String name, VertexFormat format, VertexFormat.Mode mode, RenderType.CompositeState state) {
