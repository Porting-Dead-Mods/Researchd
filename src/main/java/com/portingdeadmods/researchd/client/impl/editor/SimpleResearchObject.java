...
public class SimpleResearchObject implements StandaloneEditorObject<Research> {
    ...
    public void buildLayout(RememberingLinearLayout layout, @UnknownNullability EditorContext context) {
        ...
        layout.addWidget("effect", new EmbeddedEffectCreationWidget(context.parentPopupWidget(), 0, 0, context.innerWidth() - 4, 32, CommonComponents.EMPTY));
    }
    ...
    @Override
    public Research create(RememberingLinearLayout layout) {
