...
public class ValueEffectModifierObject implements TypedEditorObject<ResearchEffect, ResearchEffectType> {
    private final ResearchEffectType effectType;
    private final BiFunction<ValueEffect, Float, ResearchEffect> effectFactory;

    public ValueEffectModifierObject(ResearchEffectType effectType, BiFunction<ValueEffect, Float, ResearchEffect> effectFactory) {
