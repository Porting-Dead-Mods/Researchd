...
public class EditorSharedSprites {
    ...
    public static final ResourceLocation EDITOR_BACKGROUND_HIGHLIGHTED_SPRITE =
            Researchd.rl("editor_background_highlighted");
    ...
    public static final ResourceLocation EDITOR_WIDGET_BACKGROUND_SPRITE =
            Researchd.rl("widget/editor_widget_background");
