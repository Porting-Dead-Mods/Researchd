 ...
 */
public record PotentialOverlap(
        int length, Point point, LineSegment seg1, LineSegment seg2, boolean isOverlap, boolean isSegment) {
    @Override
    public @NotNull String toString() {
        return "PotentialOverlap{" + "length="
                + length + ", " + "point="
                + point + ", " + "isOverlap="
                + isOverlap + ", " + "isSegment="
                + isSegment + '}';
    ...
    public static PotentialOverlap of(LineSegment seg1, LineSegment seg2) {
        ...
        if (seg1.isVertical() && seg2.isVertical()) {
            ...
            return new PotentialOverlap(overlapLength, new Point(seg1.a().x, midY), seg1, seg2, true, true);
        }
        ...
        if (seg1.isHorizontal() && seg2.isHorizontal()) {
            ...
            return new PotentialOverlap(overlapLength, new Point(midX, seg1.a().y), seg1, seg2, true, true);
        }
