    ...
    @WrapOperation(
            ...
            at =
                    @At(
                            value = "INVOKE",
                            target =
                                    "Lcom/google/common/cache/Cache;get(Ljava/lang/Object;Ljava/util/concurrent/Callable;)Ljava/lang/Object;",
                            remap = false))
    private static Object researchd$scopeKeyToTeam(
            Cache cache, Object key, Callable loader, Operation<Object> original) {
