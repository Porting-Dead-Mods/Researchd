...
public record AndResearchEffect(List<ResearchEffect> effects) implements ResearchEffectList {
    private static final MapCodec<AndResearchEffect> CODEC = RecordCodecBuilder.mapCodec(
            inst -> inst.group(ResearchEffect.CODEC.listOf().fieldOf("effects").forGetter(AndResearchEffect::effects))
