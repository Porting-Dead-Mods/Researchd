...
public final class EditModeSettingsImpl implements EditModeSettings {
    public static final Codec<EditModeSettingsImpl> CODEC = RecordCodecBuilder.create(inst -> inst.group(
                    PackLocation.CODEC
                            .optionalFieldOf("current_datapack")
                            .forGetter(s -> Optional.ofNullable(s.currentDatapack())),
                    PackLocation.CODEC
                            .optionalFieldOf("current_resource_pack")
                            .forGetter(s -> Optional.ofNullable(s.currentResourcePack())))
    ...
    public String toString() {
        return "EditModeSettingsImpl[" + "currentDatapack="
                + currentDatapack + ", " + "currentResourcePack="
                + currentResourcePack + ']';
    }
}
