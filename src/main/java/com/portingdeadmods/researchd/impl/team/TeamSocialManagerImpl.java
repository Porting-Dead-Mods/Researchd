...
public record TeamSocialManagerImpl(
        UniqueArray<UUID> receivedInvites, UniqueArray<UUID> sentInvites, UniqueArray<UUID> ignores)
    ...
    public static final Codec<TeamSocialManagerImpl> CODEC = RecordCodecBuilder.create(inst -> inst.group(
                    UniqueArray.CODEC(UUIDUtil.CODEC)
                            .fieldOf("received_invites")
                            .forGetter(TeamSocialManagerImpl::receivedInvites),
                    UniqueArray.CODEC(UUIDUtil.CODEC)
                            .fieldOf("sent_invites")
                            .forGetter(TeamSocialManagerImpl::sentInvites),
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, TeamSocialManagerImpl> STREAM_CODEC =
    ...
    public static final TeamSocialManagerImpl EMPTY =
